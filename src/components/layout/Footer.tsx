      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-8 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 font-heading font-extrabold text-xl mb-3">
            ...
            <div className="border-t border-slate-800 pt-3 mt-3">
              ...
              <p className="text-xs text-slate-400 mb-2">{t('footer.founderRole')}</p>
              <div className="flex items-center gap-3">
                ...
                <a href="https://mukeshfolio.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="Portfolio">
