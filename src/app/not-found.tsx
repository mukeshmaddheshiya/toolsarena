...
export default function NotFound() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20 text-center">
      ...
      <h2 className="text-2xl font-heading font-bold text-slate-900 dark:text-slate-100 mb-3">Page Not Found</h2>
      ...
      <div>
        <h3 className="text-lg font-heading font-semibold text-slate-900 dark:text-slate-100 mb-4">Popular Tools</h3>
