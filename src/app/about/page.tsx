          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://mukesh-portfolio-zeta.vercel.app/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-full bg-white dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400 shadow-sm transition-colors">
